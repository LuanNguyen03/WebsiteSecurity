...
import com.example.webbanhang_7632.repository.CategoryRepository;
...
//    }
    ...
    *@param id the id of the category to delete*/
    public void deleteCategoryById(Long id) {
        if (!categoryRepository.existsById(id)) { throw new IllegalStateException("Category with ID " + id + " does not exist."); }
